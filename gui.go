...
func main() {
    ...
    win = g.NewMasterWindow("Privcord", 1200, 800, linuxFlags)
	...
	g.SingleWindow().
		...
		Layout(
			...
			g.Style().SetFontSize(20).To(
				...
				g.Dummy(0, 10),
                g.Label("Privcord Version: "+buildinfo.InstallerTag+" ("+buildinfo.InstallerGitHash+")"+Ternary(IsSelfOutdated, " - OUTDATED", "")),
